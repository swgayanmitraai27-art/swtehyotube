      ...
      <section id=pricing className=py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full text-center>
        <div className=max-w-3xl mx-auto mb-12>
          <div className=inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-semibold mb-4>
            ...
            4-Tier Creator & Bulk Agency Pricing (For Indian YouTubers)
          </div>
        ...
        <div className=grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6>
          {INDIAN_TIER_PLANS.map((plan) => {
            ...
            return (
              <div
                key={plan.id}
                className={ounded-3xl p-6 border text-left flex flex-col justify-between relative transition-all }
              >
                {plan.popular && (
                ...
                <div>
                  ...
                  <div className=mt-2 flex items-center gap-2>
                    <span className={	ext-[11px] font-bold px-2 py-0.5 rounded-lg }>
                ...
                {isCustom ? (
                  <div className=mt-6 flex flex-col gap-2>
                    <a
                      href={https://wa.me/918303994616?text=}
                      target=_blank
